...
$(document).ready(function () {
    ...
    if ('undefined' !== typeof tinymce) {
        tinymce.init({
            ...
            language: 'fr_FR',
            plugins: ["code", "advlist autolink link image lists charmap print preview hr anchor pagebreak fullscreen", "searchreplace wordcount visualblocks visualchars insertdatetime media nonbreaking", "table contextmenu directionality emoticons paste textcolor responsivefilemanager autoresize"],
            relative_urls: false,
...
},{"../libs/js/dynatable/dynatable.js":3,"bootstrap-sass":4,"jquery":5}],2:[function(require,module,exports){
'use strict';
...
},{"./init":1}],3:[function(require,module,exports){
/*
...
(function ($) {
  ...
  utility = dt.utility = {
    ...
    refreshQueryString: function refreshQueryString(urlString, data, settings) {
      ...
      for (var attr in settings.params) {
