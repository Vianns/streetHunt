...
<!-- header div end -->
	...
	<li><small class="hidden-phone">(<span id="files_number"><?php echo $current_files_number.'</span> '.trans('Files')." - <span id='folders_number'>".$current_folders_number.'</span> '.trans('Folders');
    ?>)</small></li>
	</ul>
    </div>
    <!-- breadcrumb div end -->
    ...
    ?>&file=<?php echo $rfm_subfolder.$subdir.$file;
    ?>"
